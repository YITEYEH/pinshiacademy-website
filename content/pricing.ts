...
export const pricingExplanationSection = {
  ...
  footnote:
    "課程費用將依學生的學習階段、授課科目、目前程度、授課老師、班型及堂數方案等因素綜合評估正式報名前，我們會完整說明課程內容與費用，讓家長清楚了解每一項安排，安心選擇適合的課程",
} as const;
  ...
  items: [
    {
      question: "可以只報名一堂課嗎？",
      answer:
        "可以品識學苑提供單堂預約，您也可以先預約免費學習諮詢，了解孩子的學習狀況與需求，再選擇最適合的課程方案",
    },
    {
      question: "有堂數優惠嗎？",
      answer:
        "有，多堂課程方案會比單堂預約享有更優惠的平均單堂費用如果已有明確的學習目標，例如段考、會考或學測，我們也會協助規劃更適合的課程安排",
    },
    {
      question: "有提供免費學習諮詢嗎？",
      answer:
        "有首次提供免費學習諮詢，協助了解學生目前的學習狀況、分析學習需求，並提供適合的課程規劃建議，讓家長在報名前能更安心做出選擇",
    },
    {
      question: "如何安排授課老師？",
      answer:
        "我們相信，適合的老師比任何教材都重要課程開始前，我們會了解學生的學習需求、目標與程度，並依照老師的專業領域與教學風格進行媒合，讓每位學生都能找到最適合自己的學習夥伴，若課程進行後發現不適合，也會協助調整授課老師，讓學生能持續獲得最適合的學習支持",
    },
    {
      question: "小班課程價格也一樣嗎？",
      answer:
        "小班課程採不同的收費方式，會依班級人數、課程規劃及堂數安排有所調整實際方案與費用將依課程內容提供完整說明",
    },
    {
      question: "報名後可以申請退費嗎？",
      answerPrefix: "可以品識學苑提供公開透明的退費制度，相關規定皆依",
