...
const yehYideProfile: TeacherProfileContent = {
  ...
  aboutParagraphs: [
    ...
    "課堂上，葉老師重視引導式提問，鼓勵學生先思考、再嘗試、最後整理他相信數學學習的關鍵，在於幫助學生理解「為什麼」，而不是只記住「怎麼做」",
  ...
  faq: [
    {
      question: "程度不好可以上課嗎？",
      answer:
        "可以葉老師會從學生目前的理解程度出發，先補足基礎概念，再循序建立信心與解題能力，不需要擔心「跟不上」",
    },
    {
    ...
    },
    {
      question: "多久可以看到學習成效？",
      answer:
        "因學生起點與目標不同而有所差異多數學生在建立穩定學習節奏後，約 1 至 3 個月可感受到解題思路與信心的明顯改變",
    },
    {
      question: "可以先預約諮詢再決定嗎？",
      answer:
        "當然可以歡迎先預約學習評估，我們會依孩子的狀況說明適合的課程方向，再決定是否開始上課",
    },
  ],
  footerCta: {
...
const xuXiProfile: TeacherProfileContent = {
  ...
  aboutParagraphs: [
    "徐璽老師專注國中與高中英文教學，同時協助學生準備英文檢定她擅長把單字、文法與閱讀放回真實語境中理解，讓學生不再只是死背規則，而是真正建立能理解、能表達、能應考的語言能力",
  ...
  faq: [
    {
      question: "程度不好可以上課嗎？",
      answer:
        "可以徐老師會從學生目前的理解程度出發，先補強基礎，再循序建立信心與運用能力，不需要擔心跟不上",
    },
    {
      question: "一對一和小班課程怎麼選？",
      answer:
    ...
    },
    {
      question: "多久可以看到學習成效？",
      answer:
        "因起點與目標不同而有所差異多數學生在建立穩定學習節奏後，約 1 至 3 個月可感受到理解、表達或應試信心的改變",
    },
    {
      question: "可以先預約諮詢再決定嗎？",
      answer:
