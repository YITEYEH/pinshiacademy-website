...
import { ArrowRight, Target, Users, Lightbulb, Award, CheckCircle2, XCircle } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {coreArchitecture.map((item, index) => (
              ...
              >
                ...
                <div className={`w-12 h-12 ${item.textColor} bg-white rounded-lg flex items-center justify-center mb-4`}>
                ...
                <div className="flex flex-col lg:flex-row items-start gap-6 bg-white/10 backdrop-blur-sm rounded-xl p-6 lg:p-8">
                  ...
                  <div className="flex-1">
                    <div className="mb-4">
                      ...
                      <div className="text-lg text-white/80">{item.subtitle}</div>
                    </div>
                  ...
                  >
                    ...
                    <td className="py-4 px-6 bg-[#e8f5ee]/30">
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-foreground font-medium">{row.pinshi}</span>
                      </div>
                    </td>
                  </tr>
                ))}
