...
import { ArrowRight, TrendingUp, Award, CheckCircle2, ArrowUpRight } from "lucide-react";
...
const successStories = [
  {
    ...
    testimonial: "謝謝陳老師的耐心教導，讓我發現數學其實沒有想像中那麼難！",
  },
  {
    name: "小華",
    grade: "高一",
    ...
    testimonial: "林老師教的方法讓我終於找到學英文的訣竅，現在看英文文章不再害怕了！",
  },
  {
    name: "小芳",
    grade: "國二",
    ...
    testimonial: "王老師讓我發現國文不只是考試科目，更是表達自我的工具！",
  },
];
            ...
            {successStories.map((story, index) => (
              ...
              >
                ...
                <div className="grid lg:grid-cols-2 gap-8 mb-12">
                  <div className="bg-red-50 rounded-xl p-6 border-l-4 border-red-400">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="text-3xl font-bold text-red-600">{story.before.score}</div>
                  ...
                  <div className="bg-[#e8f5ee] rounded-xl p-6 border-l-4 border-primary">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="text-3xl font-bold text-primary">{story.after.score}</div>
                  ...
                  <div className="space-y-6">
                    {story.journey.map((phase, i) => (
                      <div key={i} className="relative pl-8">
                        ...
                        <div className="mb-2">
                          <span className="font-semibold text-foreground">{phase.period}</span>
                ...
                <div className="mt-6 bg-white rounded-xl p-6 border border-primary/20 italic">
                  <p className="text-foreground">"{story.testimonial}"</p>
                  <div className="text-sm text-muted-foreground mt-2">— {story.name}</div>
                </div>
