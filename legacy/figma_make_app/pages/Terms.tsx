...
const sections = [
  {
    id: "acceptance",
    title: "服務條款接受",
    content: `歡迎使用品識學苑（以下簡稱「本學苑」）的服務。當您註冊成為本學苑的學生或使用本學苑提供的任何服務時，即表示您已閱讀、了解並同意遵守本使用政策的所有條款。如果您不同意本政策的任何內容，請勿使用本學苑的服務。`,
  },
  {
    id: "registration",
    title: "註冊與報名",
...
終止服務時，已繳費用將依情況部分或全部不予退還。`,
  },
  {
    id: "changes",
    title: "政策修訂",
    content: `本學苑保留隨時修訂本使用政策的權利。修訂後的政策將於網站公告，並於公告後生效。繼續使用服務即表示您同意修訂後的政策。重大變更將透過電子郵件或其他方式通知學生及家長。`,
  },
  {
    id: "dispute",
    title: "爭議處理",
