...
import { ArrowRight, Heart, Users, TrendingUp, Sparkles, CheckCircle2 } from "lucide-react";
...
export function TeacherRecruitment() {
  return (
                ...
                <div className="flex flex-col lg:flex-row items-start gap-6 bg-[#f7f9f7] rounded-xl p-6 lg:p-8">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-3">
                      <h3 className="text-xl font-bold text-foreground">{path.stage}</h3>
