...
const sections = [
  {
    ...
    title: "前言",
    content:
      "品識學苑（以下簡稱「本學苑」）重視每位使用者的隱私權保護。本隱私權政策說明本學苑如何蒐集、處理及利用您的個人資料，以及您所擁有的相關權利。當您使用本學苑的服務時，即表示您同意本政策所述的資料處理方式。",
  },
  {
    id: "collection",
    title: "資料蒐集",
...
如需行使上述權利，請聯繫本學苑行政部門。我們將在合理期限內處理您的請求。`,
  },
  {
    ...
    title: "Cookies 使用",
    content:
      "本學苑網站使用 Cookies 技術，以提供更好的瀏覽體驗。Cookies 是網站傳送至您瀏覽器的小型文字檔案，用於記錄您的偏好設定與瀏覽習慣。您可以透過瀏覽器設定選擇拒絕 Cookies，但這可能影響某些網站功能的使用。",
  },
  {
    id: "changes",
    title: "政策修訂",
    content:
      "本學苑保留隨時修訂本隱私權政策的權利。如有重大變更，我們會透過網站公告或電子郵件通知您。修訂後的政策將於公告時生效，請您定期查閱。",
  },
  {
    id: "contact",
    title: "聯絡我們",
